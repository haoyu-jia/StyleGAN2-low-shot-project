...
def training_schedule(
        ...
        minibatch_gpu_dict={8: 64, 16: 64, 32: 48, 64: 32, 128: 24, 256: 16, 512: 12, 1024: 8}, # Resolution-specific overrides.
        G_lrate_base=0.001,    # Learning rate for the generator.
        G_lrate_dict={},       # Resolution-specific overrides.
        D_lrate_base=0.003,    # Learning rate for the discriminator.
